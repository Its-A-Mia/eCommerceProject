    ...
    <>
      ...
      <Container maxWidth="lg" sx={{ p: '20px 0 120px' }}>
        <Box display="flex" justifyContent="center">
          <main style={{ width: '100%', display: 'inherit', justifyContent: 'inherit' }}>{children}</main>
        </Box>
      </Container>
      <footer>
        <Box sx={{ background: '#5D82B3' }}>
          ...
          >
            <Box display="flex" gap="10px" maxWidth="210px" alignItems="center">
              ...
              <Link href="https://nextjs.org/" target="_blank" style={{ textDecoration: 'none', color: 'white' }}>
                <Image src={nextjslogo.src} width={104} height={50} alt="Next js logo" />
              </Link>
            </Box>
